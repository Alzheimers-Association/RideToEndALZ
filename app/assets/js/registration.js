...
(function ($) {
  $(document).ready(function () {
    ...
    if ($('#team_find_new_team_name').length > 0 && frTmOpt === 'new') {
      ...
      $('#team_find_section_body').before('<div class="reg-text mt-3 col-md-8 offset-md-2"><p>Note: Each Rider on the Team is individually responsible for meeting their individual fundraising minimum based on the <a href="SPageServer/?pagename=ride_fundraising_packages" class="text-primary">fundraising package</a> they selected at time of registration.</p></div>');
